...
This mirrors the RAG contract from the `hyeongyu` branch and is used by the
current v9 service layer.
"""
...
class ExternalRagDecision(BaseModel):
    """Structured decision for whether external RAG should be used."""
...
__all__ = ["AllowedSourceType", "ExternalQueryRewrite", "ExternalRagDecision"]
