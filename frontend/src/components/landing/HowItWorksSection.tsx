...
const STEPS = [
  ...
  },
  {
    ...
    desc: "감성 분석 모델이 텍스트를 -1~1 점수로 평가합니다.",
    tag: "raw_score: 0.72",
    color: "purple",
  ...
  },
  {
    ...
    desc: "EMA로 노이즈를 제거하고 매매 신호를 실시간 브로드캐스트합니다.",
    tag: "action: BUY",
    color: "green",
    live: true,
              ...
              {i < STEPS.length - 1 && (
                <>
                  ...
                  <div className="flex justify-center py-1 lg:hidden">
                    <svg className="h-6 w-6 rotate-90 text-purple-500/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
